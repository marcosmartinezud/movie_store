...
def validate_css_text(css_text: str):
    # Endpoint del validador CSS del W3C
    ...
    try:
        ...
        # Si falla POST, se intenta con GET
        ...
        with urllib.request.urlopen(base + "?" + params, context=ssl_context) as resp:
            payload = resp.read().decode("utf-8")
        return json.loads(payload)
...
def collect_pages():
    ...
    # Agrega detalles del primer registro de cada tipo si existe
...
def main():
    ...
    # Valida las paginas HTML recogidas
    pages = collect_pages()
    html_report = {}
    ...
    # Sale con codigo distinto de cero si hay errores para avisar en CI o scripts
